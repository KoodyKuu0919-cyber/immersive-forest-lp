...
function App() {
    return (
        <div className="relative min-h-[400vh] text-forest-50 font-sans selection:bg-forest-500/30 bg-transparent">
            {/* Video Background */}
            <VideoScroll />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full">
                        ...
                        <div className="bg-black/40 backdrop-blur-xl rounded-[2rem] p-8 md:p-12 border border-white/10 hover:border-forest-400/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(74,222,128,0.1)] flex flex-col items-center text-center group">
                            ...
                            <a
                                ...
                                className="mt-auto px-8 py-3 bg-forest-500/20 hover:bg-forest-500/40 text-forest-100 rounded-full border border-forest-500/50 transition-all flex items-center gap-2"
                            >
                                <Lock size={16} />
                                View on Rakuten
                            </a>
